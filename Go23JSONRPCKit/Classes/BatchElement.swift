...
internal protocol BatchElementProcotol {
    associatedtype Request: Go23JSONRPCKit.Request
...
extension BatchElementProcotol where Request.Response == Void {
...
public struct BatchElement<Request: Go23JSONRPCKit.Request>: BatchElementProcotol {
